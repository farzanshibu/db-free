        ...
        {isObjectStore ? (
          <Tooltip delay={300}>
            <Button
              size="sm"
              variant="ghost"
              className="text-muted hover:bg-surface-secondary/70 hover:text-foreground liquid-hover rounded-lg"
              isDisabled={rows.length === 0 || downloading || downloadKey() === null}
            ...
            <Tooltip.Content>Download the selected file to disk (byte-exact).</Tooltip.Content>
          </Tooltip>
        ) : null}
